      ...
      <div className="footer w-full mt-[176px] border-t border-[#172136]">
        <div className="container flex justify-between py-[48px]">
          <div>
            ...
            <p className="mt-[130px] text-[#BDC4D1] text-[14px]">
              Devoptima 2023 © All rights reserved
            </p>
          </div>
          <div className="flex gap-[176px] items-start">
            <div>
              <h5 className="text-white text-[16px] font-[500]">Resources</h5>
              <ul className="mt-[16px] space-y-[12px]">
                <li className="text-[16px] text-[#BDC4D1] transition-all duration-300 hover:text-white cursor-pointer">
                  Docs
                </li>
                <li className="text-[16px] text-[#BDC4D1] transition-all duration-300 hover:text-white cursor-pointer">
                  Release notes
            ...
            <div>
              <h5 className="text-white text-[16px] font-[500]">Community</h5>
              <ul className="mt-[16px] space-y-[12px]">
                <li className="text-[16px] flex items-center gap-[10px]  group  cursor-pointer">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                  ...
                  <p className="text-[#BDC4D1]  transition-all duration-300 group-hover:text-white">
                    Twitter
                  </p>
                </li>
                <li className="text-[16px] flex items-center gap-[10px]  group  cursor-pointer">
            ...
            <div>
              <h5 className="text-white text-[16px] font-[500]">Legal</h5>
              <ul className="mt-[16px] space-y-[12px]">
                <li className="text-[16px] text-[#BDC4D1] transition-all duration-300 hover:text-white cursor-pointer">
                  Privacy policy
                </li>
